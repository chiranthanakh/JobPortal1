    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.cv_personal_loan:
                Intent intent = new Intent(LoanActivity.this, LoanFormfirst.class);
            ...
            case R.id.cv_home_loan:
                Intent intent2 = new Intent(LoanActivity.this, LoanFormfirst.class);
                startActivity(intent2);
                break;

            case R.id.cv_martgage_loan:
                Intent intent3 = new Intent(LoanActivity.this, LoanFormfirst.class);
                startActivity(intent3);
                break;

            case R.id.cv_lap:
                Intent intent4 = new Intent(LoanActivity.this, LoanFormfirst.class);
                startActivity(intent4);
                break;

            case R.id.cv_vehicle:
                Intent intent5 = new Intent(LoanActivity.this, LoanFormfirst.class);
