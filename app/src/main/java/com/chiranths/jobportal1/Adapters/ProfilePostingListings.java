...
public class ProfilePostingListings extends RecyclerView.Adapter<ProfilePostingListings.ViewHolder> {
    ...
    public ProfilePostingListings(List<ProductInfo> productInfos, Context context, String number, String name) {
    ...
    @NonNull
    @Override
    public ProfilePostingListings.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        context = parent.getContext();
        View listItem= layoutInflater.inflate(R.layout.profile_listings, parent, false);
        ProfilePostingListings.ViewHolder viewHolder = new ProfilePostingListings.ViewHolder(listItem);
        return viewHolder;
    }
